      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-lg tracking-tight text-blue-900 sm:text-2xl">
            Berikut adalah struktur Padukuhan Padaan Kulon yang terdiri dari
            Bapak Dukuh, BP. Kal, RW, dan RT. Mereka adalah tokoh-tokoh penting
            yang berperan dalam pengelolaan dan pembangunan Padukuhan Padaan
            Kulon.
          </p>
        </div>
        <Tab.Group
