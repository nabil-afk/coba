            ...
            <div className="mt-4 flex flex-col font-display text-lg tracking-tight text-green-900 sm:text-2xl">
              <div>
                <p className="max-w-[] text-justify font-display sm:text-left">
                  ...
                  <br />
                  Sebagai ketua kelompok KKN AB.83.066, saya ingin menyampaikan
              ...
              <div className="mt-4">
                <p className="font-bold">M. Nabil</p>
                <p>Ketua Kelompok KKN AB</p>
              </div>
            </div>
          </div>
        </Container>
