            ...
            <div className="mt-4 flex flex-col font-display text-lg tracking-tight text-blue-900 sm:text-2xl">
              <div>
                <p className="max-w-[] text-justify font-display sm:text-left">
                  ...
                  <br />
                  Selamat datang di Padukuhan Padaan Kulon, sebuah desa yang
                  kaya akan budaya dan tradisi. Kami sangat bangga dapat
                  menyambut mahasiswa KKN AB.83.066 yang telah berkontribusi
                  dalam pembangunan desa kami. Kehadiran mereka membawa semangat
                  baru dan ide-ide segar yang sangat bermanfaat bagi masyarakat
                  kami.
